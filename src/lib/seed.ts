...
export const SEED_LEVELS: Level[] = [
  ...
  },
  {
    ...
    config: {
      titulo: "Ordená estos inventos",
      eventos: [
        { texto: "Imprenta de Gutenberg", anio: 1440 },
        { texto: "Máquina de vapor", anio: 1769 },
        { texto: "Teléfono", anio: 1876, detalle: "Alexander Graham Bell" },
        { texto: "Primer avión", anio: 1903, detalle: "Hermanos Wright" },
        { texto: "World Wide Web", anio: 1989, detalle: "Tim Berners-Lee" },
      ],
    },
  },
  {
